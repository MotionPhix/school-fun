<div class="col-span-1 lg:col-span-2 border-e px-0">

  <div class="flex flex-col items-center sm:items-start sticky top-0">

    <ul class="flex-col py-2 px-4 w-full">
        ...
        <li class="nav-item">
            @php
                if (session()->has('browse_session_id')){
                    ...
                    $latest_session = \App\Models\SchoolYear::latest()->first();
                    if($latest_session) {
